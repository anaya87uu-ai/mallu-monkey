...
const GameResultOverlay = ({ result, onPlayAgain, onLeave, pointsEarned }: GameResultOverlayProps) => {
  ...
  return (
    <Dialog open={true} onOpenChange={() => {}}>
      <DialogContent
        className="sm:max-w-sm border-border/50 bg-background/95 backdrop-blur-xl overflow-hidden"
      ...
      >
        ...
        <div className="text-center pt-2">
          ...
          >
            <Icon className={`w-16 h-16 mx-auto ${c.iconColor}`} />
          </motion.div>
          ...
          {pointsEarned !== undefined && pointsEarned > 0 && (
            <motion.div
              ...
              className="inline-flex items-center gap-1 mt-3 px-4 py-1.5 rounded-full bg-primary/20 text-primary text-sm font-bold"
            >
              +{pointsEarned} pts
            </motion.div>
          )}
          ...
          >
            ...
            {onLeave && (
              <Button variant="outline" onClick={onLeave} className="border-border/50">
